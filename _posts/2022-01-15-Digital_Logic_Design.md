...
### [Logic Gates]({% link /_drafts/Digital_Logic_Design/2_Logic_Gate/README.md %})
- AND
- OR
- NOT
- NAND
- NOR
- XOR & XNOR
### [IC Performance Parameter]({% link /_drafts/Digital_Logic_Design/3_Performance_Parameter/README.md %})
