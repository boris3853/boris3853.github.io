...
### [Logic Gates]({% link /github/workspace/_posts/Digital_Logic_Design/2_Logic_Gate/README.md %})
- AND
- OR
- NOT
- NAND
- NOR
- XOR & XNOR
### [IC Performance Parameter]({% link /github/workspace/_posts/DIgital_Logic_Design/3_Performance_Parameter/README.md %})
